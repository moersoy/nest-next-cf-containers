/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3015dab2de833cedadad0d2e358135bb)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKER_ENV" | "DEBUG_MODE">> {}
}
